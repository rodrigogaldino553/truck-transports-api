...
RSpec.describe "/products", type: :request do
  ...
  let(:valid_attributes) {
    {payload_name: 'corn', payload_size: 12, total_billing: 800, from: 'Campo Grande, MS', to: 'Santos, SP'}
  }

  let(:invalid_attributes) {
    {payload_name: '', payload_size: 0, total_billing: 0, from: '', to: ''}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {payload_name: 'corn', payload_size: 6, total_billing: 400, from: 'Campo Grande, MS', to: 'Belo Horizonte, MG'}
      }
